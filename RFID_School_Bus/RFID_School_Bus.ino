...
void loop()
{
  ...
  if (status == MI_OK)
  {
    ...
    if (str[0] == 149) //You can change this to the first byte of your tag by finding the card's ID through the Serial Monitor
    {
      Serial.println("Welcome Mr.Sharma");
    }
    else if (str[0] == 50)
    { //You can change this to the first byte of your tag by finding the card's ID through the Serial Monitor
      Serial.println("Welcome Mr.Aggrawal");
    }
  }
